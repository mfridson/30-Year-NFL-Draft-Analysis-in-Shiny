...
library(xtable)
library(DT)
#Specifies aggregate function, defines plot and interaction based on input values for team_plot
shinyServer(function(input, output) {
  ...
  #Specifies aggregate function, defines table and interaction based on input values for Rnd_Summary
  ...
  #Specifies aggregate function, defines plot and interaction based on input values for pb_plot
  ...
  #Specifies aggregate function, defines plot and interaction based on input values for age_plot
  ...
  #Specifies aggregate function, defines table and interaction based on input values for sch_table
  ...
  #Specifies aggregate function, defines plot and interaction based on input values for qb_plot
  output$qb_plot <- renderPlot({
    ...
    #Specifies aggregate function, defines plot and interaction based on input values for rbfb_plot
    ...
    #Specifies aggregate function, defines plot and interaction based on input values for wrte_plot
    ...
    #Specifies aggregate function, defines plot and interaction based on input values for k_plot
    ...
    #Specifies aggregate function, defines plot and interaction based on input values for p_plot
